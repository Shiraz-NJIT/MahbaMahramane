...
namespace Njit.ImageListView
{
    ...
    public class ImageListViewItem
    {
        ...
        /// </summary>
        [Category("Njit"), Browsable(true), Description("Gets or sets the background color of the item."), DefaultValue(typeof(Color), "Transparent")]
        ...
        /// </summary>
        [Category("Njit"), Browsable(false), Description("Gets a value determining if the item is focused.")]
        public bool Focused
        {
            get
            {
        ...
        /// </summary>
        [Category("Njit"), Browsable(true), Description("Gets or sets the foreground color of the item."), DefaultValue(typeof(Color), "WindowText")]
        ...
        /// </summary>
        [Category("Njit"), Browsable(true), Description("Gets or sets a value determining if the item is selected."), DefaultValue(false)]
        ...
        /// </summary>
        [Category("Njit"), Browsable(true), Description("Gets or sets the user-defined data associated with the item.")]
        public object Tag { get; set; }
        /// <summary>
        /// Gets or sets the text associated with this item. If left blank, item Text 
        /// reverts to the name of the image file.
        /// </summary>
        [Category("Njit"), Browsable(true), Description("Gets or sets the text associated with this item. If left blank, item Text reverts to the name of the image file.")]
        public string Text
        {
            get
            {
        ...
        /// </summary>
        [Category("Njit"), Browsable(true), Description("Gets or sets the caption associated with this item.")]
        ...
        /// </summary>
        [Category("Njit"), Browsable(false), Description("Gets the thumbnail image.")]
        ...
        /// </summary>
        [Category("Njit"), Browsable(true), Description("Gets or sets the draw order of the item."), DefaultValue(0)]
        ...
        /// </summary>
        [Category("Njit"), Browsable(false), Description("Gets the last access date of the image file represented by this item.")]
        ...
        /// </summary>
        [Category("Njit"), Browsable(false), Description("Gets the creation date of the image file represented by this item.")]
        ...
        /// </summary>
        [Category("Njit"), Browsable(false), Description("Gets the modification date of the image file represented by this item.")]
        ...
        /// </summary>
        [Category("Njit"), Browsable(false), Description("Gets the shell type of the image file represented by this item.")]
        ...
        /// </summary>        
        [Category("Njit"), Browsable(false), Description("Gets or sets the name of the image fie represented by this item.")]
